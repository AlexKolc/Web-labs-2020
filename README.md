...
<p align="justify">Доработать <a href="https://github.com/AlexKolc/web.lab1.github.io">лабораторную работу 1</a> для работы с внешним API, позволяющим получить данные о погоде в городе.</p> 
